...
export interface IFilterBoxShadowProps {
  boxShadows: IBoxShadow[];
  id: string;
  transparent?: boolean;
}

export const FilterBoxShadow = ({
  boxShadows,
  id,
  transparent,
}: IFilterBoxShadowProps) => (
  <filter id={id} x="-50%" y="-50%" width="200%" height="200%">
    ...
    {/* Layer up the original element (if not transparent) and all the box shadows */}
    <feMerge>
      {!transparent && <feMergeNode in="SourceGraphic" />}
